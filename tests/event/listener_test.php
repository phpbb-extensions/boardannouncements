...
class event_listener_test extends \phpbb_database_test_case
{
	...
	*/
	public function setUp()
	{
		...
		$this->config = new \phpbb\config\config(array('board_announcements_enable' => 1, 'board_announcements_dismiss' => 1, 'enable_mod_rewrite' => '0'));
	...
	*/
	public function test_display_board_announcements()
	{
		...
		$this->assertEquals(array(
			...
			'S_BOARD_ANNOUNCEMENTS_DISMISS'	=> true,
